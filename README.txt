...
3.  User defines how many quantum state one needs to model each
...
    basis of first N harmonic oscillator eigenfunctions. Each cyclic
...
                 between different cyclic and oscillatory coordinate.
...
         capacitances, parasitic capacitances, mutual incuctances, 
         offset biases and charges and structure of a circuit in forms
...
             and structure (based on subclass ".Matrices").
...
        and "ModelCalculator" classes. Class "EasyModel" just simplifies
        the code.
