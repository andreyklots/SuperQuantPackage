...
      unmodified, must reproduce all the terms of the current license
      agreement. Each distribution must explicitly refer to the original
      code.
...
      or software package must reproduce all the terms of the current
      license agreement pertaining tho those parts of the new code or
...
        Name of SuperCondModel or names of its contributors
      cannot be used to promote or endorse any other products, even
      if they are derived from this software.
     
   Liability:
        No person or organization that ownes this code, participated
      or contributed to its creation, or holds the copyright, shall
      be liable for any damage, loss and all other undesireable and
