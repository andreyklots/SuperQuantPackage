...
# Same as Transmon circuit,
# but Josephson junction also allows tunneling of
# double Cooper pairs. cos2\phi-component reuces anharmonicity
MyCircuitCode = [\
...
QQ = np.linspace( 0*ut.e, 6*ut.e,  61 )
